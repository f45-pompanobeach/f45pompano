...
function page(o){
  ...
  return `<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Entry Confirmed | F45 Pompano</title><style>${css}</style></head><body><main class="shell"><section class="card"><div class="check">✓</div><div class="eyebrow">ENTRY CONFIRMED</div><h1>${esc(o.name.toUpperCase())}, YOU'RE CONFIRMED!</h1><p class="lead">Your entry has been confirmed.</p>${locality}<div class="draw"><strong>1 Month Unlimited Drawing:</strong> Your confirmed event entry puts you in the drawing for 1 Month Unlimited at F45 Pompano Beach.</div><div class="draw bonus"><strong>Bonus Drawing:</strong> Complete your first F45 class by Saturday, Sept. 19 to be entered to win a Soundcore Boom 3i waterproof portable Bluetooth speaker + a 2-pack of Owala SmoothSip Slider 20 oz tumblers — over $130 value.</div><div class="show"><b>SHOW THIS SCREEN TO THE F45 TEAM</b><span>CONFIRMATION ${esc(o.code.toUpperCase())}</span></div><p class="fine">Event and studio eligibility rules apply.</p></section></main></body></html>`
}
