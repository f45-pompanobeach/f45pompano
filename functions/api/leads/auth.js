import {adminAuthorized,authThrottle,eventForStaffCode,json,recordAuthFailure,recordAuthSuccess} from './_shared.js';
...
export async function onRequestPost({request,env}){
  ...
  if(await adminAuthorized(synthetic,env)){await recordAuthSuccess(env,request);return json({ok:true,role:'admin'})}
